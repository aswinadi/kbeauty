                    ...
                    <tbody>
                        ...
                        @forelse ($movements as $movement)
                                            @php
                                                $in = 0;
                                                $out = 0;
                                                // Logic: InventoryMovement stores qty. 
                                                // We need to determine if it's IN or OUT relative to the selected location and movement type.
                                                // However, InventoryMovement `qty` is always positive.
                                                // If to_location_id == selected_location => IN
                                                // If from_location_id == selected_location => OUT
